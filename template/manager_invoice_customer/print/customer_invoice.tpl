...
<table rules="none" cols="9" cellspacing="0" border="0" frame="void">
       ...
       {capture name=sElseContent}
            {foreach from=$aAdditionalItem item=aItem2}
                ...
                <tr>
                    ...
                    <td align="right" colspan="2" style="border-right:1px solid #969696;">
                        <font size="2">
        ...
        <tr class="bordered">
            ...
            <td align="center">{if $aItem.pref}{$aItem.pref}{if $aItem.pref_changed} => {$aItem.pref_changed}{/if}{else}&nbsp;{/if}</td>
            <td align="left">{if $aItem.code}{$aItem.code}{if $aItem.code_changed} => {$aItem.code_changed}{/if}{else}&nbsp;{/if}</td>
        ...
        {if $smarty.capture.sElseContent ne '' && $iCountRows > 1}
            ...
            <tr>
                <td colspan="9" align="right" style="border-right:1px solid #969696;border-bottom:1px solid #969696;">
                    <font size="2">
...
{if ! $bNoFopData}
        ...
        <tr>
            <td height="18" align="left" colspan="8"><b><font size="2">{$aInvoice.sTotalSumText}</font></b></td>
            <td align="left"><font size="2"><br />
            </font></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td valign="top" align="right" style="border-bottom: 1px solid rgb(0, 0, 0);">&nbsp;</td>
