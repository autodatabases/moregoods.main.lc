...
<table width=100% border=0>
   	<tr>	
   		...
   		<td align="center" width="50%" nowrap><input name=data[type_number] type="text" value="{$smarty.request.data.type_number}"  style="width:187px">
			...
			{if !$bShowButtonTypemines}&nbsp;&nbsp;<input class="btn" value="{$oLanguage->getMessage("Search")}" type="submit">{/if}
   		</td>
  	...
  	{if $bShowButtonTypemines}
   	<tr>	
   		<td width="100px"></td>
   		<td align="center" width="40%"><input class="btn" value="{$oLanguage->getMessage("Search")}" type="submit"> &nbsp;&nbsp;&nbsp;</td>
  	</tr>
  	{/if}
</table>
</form>
