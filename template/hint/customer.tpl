...
{/if}
<span onmouseover="$('#{$aData.login}{$aData.id}').toggle();"
	onmouseout="$('#{$aData.login}{$aData.id}').toggle();"><a href="#"
...
<div align=left style="display: none; width: 350px;" class="tip_div" id="{$aData.login}{$aData.id}">
