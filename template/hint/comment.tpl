...
<p>
<div style="float:left;"><input name="submit" value="{$oLanguage->getMessage('Submit comment')}" type="button" class='btn'
		onclick="xajax_process_form(xajax.getFormValues(this.form));">
</div>
<div style="float:right;"><input name="submit" value="{$oLanguage->getMessage('Close comment')}" type="button" class='btn'
