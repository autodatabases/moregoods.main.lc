{*<input type=button class='btn' value="{$oLanguage->getMessage("Export selected to Excel")}"
	onclick="mt.ChangeActionSubmit(document.getElementById('table_form'),'manager_export');">*}
<input type=button class='btn' value="{$oLanguage->getMessage("Export all filtered to Excel")}"
	onclick="location.href='/?action=manager_export_all';">
{if $aAuthUser.is_super_manager}
<input type=button class='btn' value="{$oLanguage->getMessage("Import statuses from Excel")}"
...
<input type=button class='btn' value="{$oLanguage->getMessage("Export selected to Mega")}"
	onclick="mt.ChangeActionSubmit(this.form,'manager_export_mega');">
<input type=button class='btn' value="{$oLanguage->getMessage("Export all filtered to Mega")}"
