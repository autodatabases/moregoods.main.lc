<?php /* Smarty version 2.6.18, created on 2017-05-16 19:42:29
         compiled from mpanel/log_mail/search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'mpanel/log_mail/search.tpl', 14, false),)), $this); ?>
...
<table cellspacing=0 cellpadding=2 class=add_form>
	...
	<tr>
		...
		<table cellspacing=2 cellpadding=1 width=850>
			<tr>
				<td><?php echo $this->_tpl_vars['oLanguage']->GetMessage('Address'); ?>
:</td>
				<td><input type=text name=search[address]
					value="<?php echo ((is_array($_tmp=$this->_tpl_vars['aSearch']['address'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" maxlength=50 style='width: 110px'></td>

				<td><?php echo $this->_tpl_vars['oLanguage']->GetMessage('Subject'); ?>
:</td>
				<td><input type=text name=search[subject]
					value="<?php echo ((is_array($_tmp=$this->_tpl_vars['aSearch']['subject'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" maxlength=50
					style='width: 110px'></td>

				<td><?php echo $this->_tpl_vars['oLanguage']->GetMessage('Date from'); ?>
:</td>
...
"
				...
				<td><?php echo $this->_tpl_vars['oLanguage']->GetMessage('Date To'); ?>
:</td>
