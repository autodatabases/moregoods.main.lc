<?php /* Smarty version 2.6.18, created on 2018-02-19 23:23:39
...
<div align="left">
	...
	<?php $this->assign('variable_lang', ((is_array($_tmp=$this->_tpl_vars['print_language_prefix'])) ? $this->_run_mod_handler('cat', true, $_tmp, "_doc_print::Рахунок на оплату №") : smarty_modifier_cat($_tmp, "_doc_print::Рахунок на оплату №"))); ?>
...
,<?php echo $this->_tpl_vars['aActiveAccount']['description']; ?>
...
<?php endif; ?><?php else: ?><i><?php echo $this->_tpl_vars['oLanguage']->getMessage('cart_invisible'); ?>
				...
				<td align="center" style='border-left:1px solid #000000; border-bottom:1px solid #000000;'>
					<span style='font-family: Arial; font-size: 8pt; font-style: normal;'>
					<?php echo $this->_tpl_vars['aItem']['count_fact']; ?>
				...
				<td align="right" style='border-left:1px solid #000000; border-bottom:1px solid #000000;'>
					<span style='font-family: Arial; font-size: 8pt; font-style: normal;'>
					<?php echo $this->_tpl_vars['oCurrency']->PrintPrice($this->_tpl_vars['aItem']['price_fact'],1); ?>
				...
				<td align="right" style='border-left:1px solid #000000;
					border-bottom:1px solid #000000;border-right:2px solid #000000;'>
					<span style='font-family: Arial; font-size: 8pt; font-style: normal;'>
					<?php $this->assign('price_fact', $this->_tpl_vars['oCurrency']->PrintPrice($this->_tpl_vars['aItem']['price_fact'],1,2,'<none>')); ?>
					<?php $this->assign('count_fact', $this->_tpl_vars['price_fact']*$this->_tpl_vars['aItem']['count_fact']); ?>
					<?php echo $this->_tpl_vars['oCurrency']->PrintSymbol($this->_tpl_vars['count_fact'],1); ?>
    ...
    <tr>
	    ...
	    <td align="center">
	    	<span style='font-family: Arial; font-size: 10pt; font-style: normal;font-weight: bold;'>
	    	<?php echo $this->_tpl_vars['oCurrency']->PrintPrice($this->_tpl_vars['aCartPackage']['summa_fact'],1); ?>
...
<?php if ($this->_tpl_vars['aCartPackage']['bonus'] > 0): ?>
<br>
<span style='font-family: Arial; font-size: 10pt; font-style: normal;font-weight: bold;'>
<?php echo $this->_tpl_vars['oLanguage']->GetMessage('bonus'); ?>
: <?php echo $this->_tpl_vars['oCurrency']->PrintPrice($this->_tpl_vars['aCartPackage']['bonus'],1); ?>
