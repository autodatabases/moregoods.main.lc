<?php /* Smarty version 2.6.18, created on 2017-05-20 08:06:22
         compiled from mpanel/ec_products/row_ec_products.tpl */ ?>
...
<?php elseif ($this->_tpl_vars['sKey'] == 'img'): ?><td><img src='<?php echo $this->_tpl_vars['aRow']['img']; ?>
' align=left hspace=3 width=40></td>
<?php elseif ($this->_tpl_vars['sKey'] == 'img2'): ?><td><img src='<?php echo $this->_tpl_vars['aRow']['img2']; ?>
' align=left hspace=3 width=40></td>
