...
<a href="/?action=store_input_invoice_manual_delete&id={$aRow.id}"
...
{elseif $sKey=='price'}
<td>{include file='store/editable_input.tpl' sTable='store_basket' sCol='price' iRowId=$aRow.id sValue=$aRow.price}</td>
{elseif $sKey=='tax'}
<td>{include file='store/editable_input.tpl' sTable='store_basket' sCol='tax' iRowId=$aRow.id sValue=$aRow.tax}</td>
