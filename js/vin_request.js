...
MstarVinRequest.prototype.AddRow = function (form)
{
	...
	if (a!=100) {
		...
		tr.cells[1].innerHTML="<input type=text name=\"azpDescript"+b+"\" maxlength=\"100\" style=\"width:330px !important;\" value=\"\">\n";
		tr.cells[2].innerHTML="<input type=text name=\"azpCnt"+b+"\" maxlength=\"2\" style=\"width:25px !important;\" value=\"1\">\n";
	}
...
MstarVinRequest.prototype.AddManagerRow = function (form)
{
	...
	if (a!=100) {
		...
		tr.cells[6].innerHTML="<input type=text name='part["+b+"][weight]' value='' style='width:30px;'> kg";
