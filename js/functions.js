$(document).ready(function() {
    ...
    $('.addAddress').click(function(){
    	var obj = $(this);
    	obj.parent().append("<div><textarea name='data[addreses][]' value='' style='width:270px'></textarea><input type='button' class='btn rmAddress' onclick='$(this).parent().remove();' value='-'></div>");
    });
